      ...
      <div className="flex flex-col gap-6 mt-20">
        {metadataJson.map((article) => {
          return (
            ...
            >
              <h1 className="text-custom-chaKy font-medium tracking-wider text-3xl mb-2 font-customEyeCatcher">
                {article.title}
              </h1>
              <div className="flex items-center gap-1 text-sm text-custom-whiskey font-medium tracking-wider mb-1.5">
              ...
              <h2 className="text-sm text-custom-whiskey font-medium tracking-wider ">
                {article.subtitle}
              </h2>
